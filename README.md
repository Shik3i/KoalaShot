...
[![Build](https://img.shields.io/badge/Build-v0.5.1-blue)](https://github.com/Shik3i/KoalaShot/releases)
...
dist/chrome/
dist/firefox/
dist/koalashot-chrome-0.5.1.zip
dist/koalashot-firefox-0.5.1.zip
dist/landing/
```
