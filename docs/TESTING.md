...
| Basic long page | Chrome-for-Testing full flow passed | Pending manual run | Firefox BiDi full flow passed |
...
| Editor handoff, draft reload, expiry, discard | Editor handoff/reload/discard passed; expiry pending | Pending manual run | Editor handoff/reload/discard passed; expiry pending |
